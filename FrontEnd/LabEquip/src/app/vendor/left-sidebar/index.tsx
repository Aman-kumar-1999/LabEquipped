...
const VendorSidebar = () => {
  ...
  return (
    <aside aria-label="Vendor navigation" className="admin-sidebar x-card d-none d-md-block" id="adminSidebar">
      <div className="p-3 border-bottom">
        <span className="fw-bold">Vendor Navigation</span>
      </div>
      <nav className="nav flex-column p-2 ">
        {menu.map((item, index) => {
          const isActive = pathname === item.href;
          console.log("Pathname:", pathname, "Item Href:", item.href, "Is Active:", isActive);
          return (
            <Link
